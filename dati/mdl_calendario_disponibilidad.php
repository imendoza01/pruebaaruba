...
<body style="background-color: #ff9900; color: #000000; padding: 0; margin: 0;">
<div style="width: 100%; padding: 10px 0 10px 20px; margin: 0; border-bottom: 2px solid #000000; background-color: #ebebeb;"><a href="Happy Island" style="color: #000000;" target="_top"><img style="text-decoration: none; border: 0px;" src="C:\\xampp\\htdocs\\residence\\croce.gif" alt="Vuelve a la HOME"></a></div>
...
<!-- FINAL DE LA PRIMERA PARTE DEL HTML PERSONAL  -->
...
# PRINCIPIO DE LAS VARIABLES MODIFICABLES (modificar el valor a la derecha)

# Insertar en esta variable el nobre de la página si $PHP_SELF no está definida
$var_nombre_pagina = "";

$var_agno = 2015;
$var_tipo_db = "mysqli";
$var_nombre_db = "hotelaruba";
$var_ordenador_db = "localhost";
$var_puerta_db = "3306";
$var_usuario_db = "root";
$var_contrasegna_db = "";
$var_carga_extension_db = "";
$var_perefijo_tablas_db = "tbl_";
$var_idioma_modelo = "es";
$var_ampliar_ultima_fecha = "SI";
$var_tarifas_a_ensegnar = array( 1 => "SI", 2 => "SI", 3 => "SI", 4 => "SI", 5 => "SI", 6 => "SI", 7 => "SI", 8 => "SI");
$var_nombres_tarifas_impuestas = array();
$var_considera_motivaciones_regla1 = array();
$var_fecha_preseleccionada = "";
$var_numero_dias = "31";
$var_alinear_disponibilidad_con_llegada = "NO";

$var_agrupar_cuadro_disponibilidad_con_regla_2 = "SI";
$var_agrupar_cuadro_disponibilidad_con_personas = "NO";
$var_estilo_tabla_cal = "border=1 cellspacing=0 cellpadding=1  style=\"background-color: #dddddd; font-size:70%; text-align: center; margin-left: auto;  margin-right: auto;\"";
$var_color_inicio_semana_cuadro_disponibilidad = "#bbbbbb";
$var_color_libre_cuadro_disponibilidad = "#0cc80c";
$var_color_ocupado_cuadro_disponibilidad = "#f8011e";
$var_apertura_elemento_letras_cuadro_disponibilidad = "";
$var_cierre_elemento_letras_cuadro_disponibilidad = "";
$var_ensegna_numero_libres_cuadro_disponibilidad = "NO";

$var_apertura_elemento_letras = "<small>";
$var_cierre_elemento_letras = "</small>";
$var_archivo_css_frame = "";
$var_tema_modelo = "default";
$var_color_tema_1 = "#000000";
$var_color_tema_2 = "#ff9900";
$var_color_tema_3 = "#ebebeb";
$var_valor_tema_1 = "Happy Island";
$var_valor_tema_2 = "C:\\xampp\\htdocs\\residence\\croce.gif";
$var_valor_tema_3 = "Vuelve a la HOME";

# FRASES
$var_fr_tarifa = "tarifa";
$var_fr_persona = "persona";
$var_fr_personas = "personas";
$var_fr_Enero = "Enero";
$var_fr_Febrero = "Febrero";
$var_fr_Marzo = "Marzo";
$var_fr_Abril = "Abril";
$var_fr_Mayo = "Mayo";
$var_fr_Junio = "Junio";
$var_fr_Julio = "Julio";
$var_fr_Agosto = "Agosto";
$var_fr_Septiembre = "Septiembre";
$var_fr_Octubre = "Octubre";
$var_fr_Noviembre = "Noviembre";
$var_fr_Diciembre = "Diciembre";
$var_fr_Cuadro_indicativo_disponibilidad = "Cuadro indicativo disponibilidad";
$var_fr_freccia_destra = "-->";
$var_fr_freccia_sinistra = "<--";

# PERIODOS EN LOS MENUS
$var_lista_periodos = "<option value=\"2015-09-01\">Sep 01 Ma, 2015</option>
...
# FINAL DE LAS VARIABLES MODIFICABLES
...
else echo "La variable \$PHP_SELF no está definida, habrá que editar a mano esta página para insertar el nombre.<br>";
} # fine if (!$pag)

define(C_PERCORSO_A_DATI,"C:\xampp\htdocs\aruba\dati/");

$anno = $var_agno;
$PHPR_DB_TYPE = $var_tipo_db;
$PHPR_DB_NAME = $var_nombre_db;
$PHPR_DB_HOST = $var_ordenador_db;
$PHPR_DB_PORT = $var_puerta_db;
$PHPR_DB_USER = $var_usuario_db;
$PHPR_DB_PASS = $var_contrasegna_db;
if (strtoupper($var_carga_extension_db) == "SI") $PHPR_LOAD_EXT = "SI";
else $PHPR_LOAD_EXT = "NO";
$PHPR_TAB_PRE = $var_perefijo_tablas_db;
$lingua_modello = $var_idioma_modelo;
if (strtoupper($var_ampliar_ultima_fecha) == "SI") $estendi_ultima_data = "SI";
else $estendi_ultima_data = "NO";
unset($tariffe_mostra);
reset ($var_tarifas_a_ensegnar);
while (list ($key, $val) = each ($var_tarifas_a_ensegnar)) {
if (strtoupper($val) == "SI") $tariffe_mostra[$key] = "SI";
if (strtoupper($val) == "NO") $tariffe_mostra[$key] = "NO";
} # fine while
$n_tariffe_imposte = $var_nombres_tarifas_impuestas;
unset($motivazioni_regola1);
reset ($var_considera_motivaciones_regla1);
while (list ($key, $val) = each ($var_considera_motivaciones_regla1)) {
if (strtoupper($val) == "SI") $motivazioni_regola1[$key] = "SI";
if (strtoupper($val) == "NO") $motivazioni_regola1[$key] = "NO";
} # fine while
$data_preselezionata = $var_fecha_preseleccionada;
$numero_giorni = $var_numero_dias;
if (strtoupper($var_alinear_disponibilidad_con_llegada) == "SI") $allinea_disponibilita_con_arrivo = "SI";
else $allinea_disponibilita_con_arrivo = "NO";

$mostra_quadro_disp = "app";
if (strtoupper($var_agrupar_cuadro_disponibilidad_con_personas) == "SI") $mostra_quadro_disp = "pers";
if (strtoupper($var_agrupar_cuadro_disponibilidad_con_regla_2) == "SI") $mostra_quadro_disp = "reg2";
$stile_tabella_cal = $var_estilo_tabla_cal;
$c_inisett_tab_disp = $var_color_inicio_semana_cuadro_disponibilidad;
$c_libero_tab_disp = $var_color_libre_cuadro_disponibilidad;
$c_occupato_tab_disp = $var_color_ocupado_cuadro_disponibilidad;
$aper_font_tab_disp = $var_apertura_elemento_letras_cuadro_disponibilidad;
$chiu_font_tab_disp = $var_cierre_elemento_letras_cuadro_disponibilidad;
if (strtoupper($var_ensegna_numero_libres_cuadro_disponibilidad) == "SI") $mostra_num_liberi = "SI";
else $mostra_num_liberi = "NO";

$apertura_tag_font = $var_apertura_elemento_letras;
$chiusura_tag_font = $var_cierre_elemento_letras;
$file_css_frame = $var_archivo_css_frame;
$extra_head_frame = "<style type=\"text/css\">
 body { background-color: #ff9900; color: #000000; }
...
# FRASI
$fr_Euro = $var_fr_divisa_sing;
$fr_Euros = $var_fr_divisa_plur;
$fr_tariffa = $var_fr_tarifa;
$fr_persona = $var_fr_persona;
$fr_persone = $var_fr_personas;
$fr_Gennaio = $var_fr_Enero;
$fr_Febbraio = $var_fr_Febrero;
$fr_Marzo = $var_fr_Marzo;
$fr_Aprile = $var_fr_Abril;
$fr_Maggio = $var_fr_Mayo;
$fr_Giugno = $var_fr_Junio;
$fr_Luglio = $var_fr_Julio;
$fr_Agosto = $var_fr_Agosto;
$fr_Settembre = $var_fr_Septiembre;
$fr_Ottobre = $var_fr_Octubre;
$fr_Novembre = $var_fr_Noviembre;
$fr_Dicembre = $var_fr_Diciembre;
$fr_Quadro_indicativo_disponibilita = $var_fr_Cuadro_indicativo_disponibilidad;
$fr_freccia_destra = $var_fr_freccia_destra;
$fr_freccia_sinistra = $var_fr_freccia_sinistra;

# PERIODI NEI MENU
$menu_periodi = $var_lista_periodos;

function mex_data($messaggio) {

###########################################
###  INIZIO ./includes/lang/es/giorni_mesi.php 
###########################################
...
###########################################
###  FINE ./includes/lang/es/giorni_mesi.php 
###########################################
...
###########################################
define(C_VERSIONE_ATTUALE,2.12);
define(C_DIFF_ORE,0);
...
<!-- PRINCIPIO DE LA SEGUNDA PARTE DEL HTML PERSONAL  -->
...
<!-- FINAL DE LA SEGUNDA PARTE DEL HTML PERSONAL  --><?php } # fine if (!$framed) ?>