...
$pag = "inizio.php";
$titolo = "Hotel V.C. Tairona Enterprice N.V.";
...
$anno_utente_attivato = "SI";
$modifica_pers = "NO";	//pestana configuraciones
$priv_crea_backup = "n";	// pestana configuraciones y backup
$inserimento_nuovi_clienti = "SI";
$modifica_clienti = "SI";	//insertar nuevo cliente
$vedi_clienti = "SI";	//buscar cliente
$priv_vedi_messaggi = "n";	//mensajes
$priv_vedi_beni_inv = "n";	//inventario y almacenes
$priv_vedi_inv_mag = "n";	//inventario y almacenes
$priv_vedi_inv_app = "n";	//inventario y almacenes
$priv_ins_nuove_prenota = "s";	//nueva reserva
$priv_ins_spese = "n";	//gastos y entradas
$priv_ins_entrate = "n";	//gastos y entradas
$priv_mod_prenotazioni = "n";
$priv_mod_costi_agg = "n";	//punto de venta
$priv_mod_pagato = "s";
...
$priv_vedi_tab_costi = "n";
$priv_vedi_tab_periodi = "n";
$priv_vedi_tab_regole = "n"; 	//reglas de asignacion
$priv_vedi_tab_appartamenti = "s"; //habitaciones
$priv_vedi_tab_doc = "n";	//documentos o facturas
$priv_vedi_tab_stat = "n";	//estadisticas
$priv_mod_tariffe = "s";
...
if (!$numconnessione and C_MOSTRA_COPYRIGHT != "NO") echo "<table style=\"background-transparent: #ffffff; width: 99%; height: 97%; margin-right: auto; margin-left: auto;\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
<tr><td>";
...
if (!defined('C_URL_LOGO') or C_URL_LOGO == "") echo "<div id=\"mmenu\" class=\"mmmenu\">";
